...
abstract class PointerDBAdapter {
	...
	static final Schema SCHEMA = new Schema(PointerDBAdapterV3.VERSION, "Pointer ID", 
	    new Field[] { LongField.INSTANCE, LongField.INSTANCE, ByteField.INSTANCE, IntField.INSTANCE },
